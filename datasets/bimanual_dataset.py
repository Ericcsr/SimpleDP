...
class BimanualPointCloudDataset(torch.utils.data.Dataset):
    def __init__(self,
                 dataset_path: str,
                 pred_horizon: int,
                 obs_horizon: int,
        ...
        train_pointcloud_data = dataset_root['data']['pcd'][:]
        train_pointcloud_data = np.moveaxis(train_pointcloud_data, -1,1)
        # (N,3,96,96)
